...
{
    public class ReportManager2010 : IReportManager
    {
        ...
        public string DeployReport(string localPath, string serverPath)
        {
            ...
            var catalog = ReportingService.CreateCatalogItem(Utility.GetFileType(Path.GetExtension(localPath)), reportName, serverPath, true, definition, null, out warnings);
